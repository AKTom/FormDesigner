...
var ControlProperty = {
    IsRequired: {
        ...
        Function: function (control, value) {
            control.Me[0].querySelector(".Span_LineControl_title_font").innerHTML = control.Property.Title + (value ? '<i class="Span_RedStar">*</i>' : '');
            control.Me[0].querySelector(".Span_LineControl_tip_font").innerHTML = control.Property.Tooltip + (value ? "[必填]" : "");
        },
        IsRequired: true,
        ...
        Group: GroupType.Function,
        Function: function (control, value) {
            control.Me[0].querySelector(".Span_LineControl_title_font").innerHTML = value || "[暂无]";
        },
        IsRequired: false
    }, Url: {
        Name: "Url",
    ...
    //属性重写
    PropertyInit: function (property, fun, attribute) {
        if (!!fun) property.Function = fun;
        if (!!attribute) {
